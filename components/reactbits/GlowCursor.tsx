...
const GlowCursor = ({
  ...
  useEffect(() => {
    ...
    const moveTarget: EventTarget = trackWindow ? window : container;
    moveTarget.addEventListener('pointermove', updatePointer as EventListener);
    if (!trackWindow) {
    ...
    return () => {
      ...
      moveTarget.removeEventListener('pointermove', updatePointer as EventListener);
      if (!trackWindow) {
